...
const FollowingUserPosts = () => {
    ...
    return (
        <div className="home">
                    ...
                    <div className="card home_card" key={post.post_id}>
                        <div style={{
                            ...
                            <h5 style={{
                                ...
                                {
                                    (state.name == post.postedby) && <i className="material-icons" style={{ 'float': 'right',"cursor" : "pointer" }} onClick={() => deletePost(post.post_id)}>delete</i>
                                }
                            </h5>
                        </div>
            ...
            <div>
                <h3 style={{ "margin": "auto auto" }}>Ooops...! You are not following anyone.</h3>
            </div>
            }
